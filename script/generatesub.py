...
for i in range(1, numnode+1):
    ...
    f.write('#SBATCH --ntasks=' + str(i*i+1) +'\n')
    ...
    f.write('source /etc/profile.d/modules.sh \n')
    f.write('module load openmpi-4.0.0 \n')
    f.write('mpirun -n ' +  str(i*i+1)  + ' ./path-mpi-cannon.x -n 1200\n')
    f.write('\n')
...
for i in range(1, numnode+1):
    ...
    f.write('source /etc/profile.d/modules.sh \n')
    f.write('module load openmpi-4.0.0 \n')
    f.write('mpirun -n ' +  str(i*i+1)  + ' ./path-mpi-cannon.x -n ' + str(i*200) + '\n')
    f.write('\n')
...
for i in range(1, numnode+1):
    ...
    f.write('#SBATCH --ntasks=' + str(i*10) +'\n')
    f.write('#SBATCH --cpus-per-task=1\n')
    f.write('#SBATCH --get-user-env \n')
    f.write('#SBATCH -t 00:10:00 \n')
    f.write('#SBATCH --mem-per-cpu=1000 \n')
    ...
    f.write('source /etc/profile.d/modules.sh \n')
    f.write('module load openmpi-4.0.0 \n')
    f.write('mpirun -n ' +  str(i*10)  + ' ./path-mpi.x -n 1200\n')
    f.write('\n')
...
for i in range(1, numnode+1):
    ...
    f.write('source /etc/profile.d/modules.sh \n')
    f.write('module load openmpi-4.0.0 \n')
    f.write('mpirun -n ' +  str(i*10) + ' ./path-mpi.x -n ' + str(i*200) + '\n')
    f.write('\n')
